...
try{
 ...
 for(let i=0;i<16;i++){
  ...
  if(i===1||i===6)await page.screenshot({path:`docs/screenshots/v2/pi-${i===1?'event':'conditions'}.png`,animations:'disabled'});
  await page.keyboard.press('ArrowRight');
 }
 await writeFile('docs/screenshots/v2/pi-font-check.json',JSON.stringify(evidence,null,2));console.log('Pi Chromium rendered official Stone and Museo fonts across all 16 views.');
