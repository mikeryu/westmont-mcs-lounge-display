...
try{
 ...
 await writeFile('docs/screenshots/v2/pi-font-check.json',JSON.stringify(evidence,null,2));console.log('Pi Chromium rendered official Stone and Museo fonts across all 15 views.');
